// Preload the latest version as early as possible
let preloadedVersion = null;

(async function preloadVersion() {
    ...
    try {
        ...
        preloadedVersion = data.name || fallbackVersion;
    } catch {
        preloadedVersion = fallbackVersion;
    }
})();
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Use the preloaded version
    if (preloadedVersion) {
        replaceVersion(preloadedVersion);
    } else {
        console.error("Failed to preload version. Exiting.");
    }
});
